...
<body>
    ...
    <div class="payment-atm">
        <div class="payment-qr">
            <img src="img/IMGATM2.jpg" alt="Mã QR thanh toán">

            <div class="pay-content-right-button">
                <a href="thanks_you.php">
                    <button>ĐÃ THANH TOÁN THÀNH CÔNG</button>
                </a>
            </div>
        </div>
                    ...
                    <nav class="menu-footer-extra-container">
                        ...
                        <ul id="footer-menu" class="footer-menu nav-menu menu">
                            <li id="menu-item-7396"
                                ...
                                <a href="index.php ">Cảm ơn bạn đã mua hàng của NTKQ-Shop !!!</a>
                            </li>
