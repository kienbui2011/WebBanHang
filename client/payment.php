        ...
        <div class="payment-content row">
            <div class="payment-content-left">
                ...
                <div class="payment-content-left-method-delivery">
                    <p style="font-weight: bold;color: black;"> Phương thức giao hàng</p>
                ...
                <div class="payment-content-left-method-payment">
                    <p style="font-weight: bold;color: #000;">Phương thức thanh toán</p>
                    <p>Mọi giao dịch đều được bảo mật và mã hóa. Thông tin thẻ tín dụng không bao giờ được lưu lại </p>
            ...
            <div class="payment-content-right">
                <table>
                    ...
                    // Define the SQL query to fetch order details from the tbl_order table
                    $orderDetailsQuery = "SELECT tbl_product.*, tbl_order_details.*
                    FROM tbl_product
                    INNER JOIN tbl_order_details ON tbl_product.product_id = tbl_order_details.product_id;
                    ";
                    ...
                    while ($row = mysqli_fetch_assoc($orderDetailsResult)) {
                        ...
                        echo '<td><p>' . $row['price'] . ' <sup>đ</sup></p></td>';
                        echo '</tr>';
                    }
                ...
                if ($totalPrice2 > 2000000) {
                    ...
                    $shippingMessage = "Phí ship: 30.000đ";
                }

                ?>
                <style>
                    .payment-content-right-total {
                        text-align: center;
                        margin-top: 10px;
                    }
                ...
                <div class="payment-content-right-total">
                    <tr>
                       <h5>TỔNG</h5> 
                        <td>
                            <p style="color:#1192E5; 
                             font-size: 25px;
                            font-weight: bold;
                            margin-top: -30px;
                            ">
                                <?php echo number_format($totalPrice2, 0, ',', '.') . ' VNĐ'; ?></p>
                        </td>
                    </tr>
                </div>
