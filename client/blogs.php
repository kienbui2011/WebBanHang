                            ...
                            <ul>
                                <li class="category-left-li"><a href="./cartegory/cartegory_DamBody.php"><u>KIỂU
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="./cartegory/cartegory_VayDamMuaHe.php">Váy đầm xuân hè</a></li>
                                    </ul>
                                </li>
                                <li class="category-left-li"><a href="./cartegory/cartegory_AoSoMi.php"><u>QUẦN
                                            ÁO</u></a>
                                    <ul>
                                        <li><a href="./cartegory/cartegory_AoSoMi.php">Áo</a></li>
                                        <li><a href="./cartegory/cartegory_QuanJean.php">Quần</a></li>
                                    </ul>
                                </li>
    ...
    <section class="cartegory">
        <div class="container">
            <div class="category-top ">
                <p>Trang chủ &nbsp; &nbsp;&nbsp;<span> <sup> &#10230;</sup></span> &nbsp; &nbsp;&nbsp; Tin tức </p>
            </div>
        
            <article>
                <h3>THỜI TRANG HIỆN NAY</h3>
                <div class="new_list">
                    <div class="new_item">
                        <p><a href="https://vietgiaitri.com/thoi-trang/">4 kiểu váy công sở mùa lạnh khiến bạn trông nặng cân hơn</a></p>
                        <img src="./img/tt2.jpg" alt="">
                        <div class="content">
                            Mùa thu đến mang theo không khí mát mẻ và có
                            phần dễ chịu sau những ngày hè oi bức. Đây chính
                            là thời điểm tuyệt vời để biến hóa phong cách thời
                            trang của bạn...
                        </div>
                    ...
                    <div class="new_list">
                        <div class="new_item">
                            <p><a href="https://www.vascara.com/tai-tro/vascara-tiep-tuc-hop-tac-cung-ntk-le-thanh-hoa-trong-fashion-voyage">NTK LÊ THANH HÒA TRONG FASHION VOYAGE MỚI NHẤT ....</a></p>
                            <img src="./img/att7.jpg" alt="">
                            <div class="content">
                                Hơn cả sự kết hợp thông thường, Vascara và NTK Lê
                                Thanh Hòa là những tri kỷ thời trang khi cùng nhau
                                sáng tạo và thổi hồn vào BST “Like the sunshine”
                                trong...
                            </div>
                        ...
                        <div class="new_list">
                            <div class="new_item " id="fix">
                                <p><a href="https://www.vascara.com/tai-tro/thiet-ke-boots-dam-chat-thu-dong-cua-vascara-co-mat-tren-san-runway-cua-ntk-vo-cong-khanh">Thiết kế Boots đậm chất Thu Đông của Vascara có mặt trên sàn runway...</a></p>
                                <img src="./img/att6.jpg" alt="">
                                <div class="content">
                                    Trong buổi trình diễn ra mắt BST Red Holiday của
                                    NTK Võ Công Khanh tại chương trình Vietnam
                                    International Fashion Festival 2021(VIFF), Combat
                                    Boots của...
            ...
            <article>
                <div class="new_list">
                    <div class="new_item">
                        <p><a href="https://vietgiaitri.com/4-kieu-vay-lien-mua-lanh-khien-phong-cach-cua-ban-loi-mot-20231104i7018975/">kiểu váy liền mùa lạnh khiến phong cách của bạn lỗi mốt</a></p>
                        <img src="./img/att12.jpg" alt="">
                        <div class="content">
                            Váy liền đứng dáng ghi điểm ở vẻ lịch sự, chỉn chu.
                            Tuy nhiên, nếu muốn trẻ hóa phong cách, chị em không
                            nên sắm mẫu váy này cho tủ đồ
                        </div>

                    </div>
                    <div class="new_list">
                        <div class="new_item">
                            <p><a href="https://vietgiaitri.com/5-mau-ao-blazer-dep-kinh-dien-duoc-phu-nu-phap-dien-mai-khong-chan-20231101i7016724/">5 mẫu áo blazer đẹp kinh điển, được phụ nữ Pháp diện mãi không chán</a></p>
                            <img src="./img/att13.jpg" alt="">
                            <div class="content">
                                Phong cách thời trang của phụ nữ Pháp gây ấn tượng
                                ở sự sang trọng, thanh lịch. Đây cũng chính là lý do
                                áo blazer là một phần khó có thể thiếu trong tủ đồ của
                                các quý cô người Phá...
                            </div>

                        </div>
                        <div class="new_list">
                            <div class="new_item " id="fix">
                                <p><a href="https://www.vascara.com/tai-tro/thiet-ke-boots-dam-chat-thu-dong-cua-vascara-co-mat-tren-san-runway-cua-ntk-vo-cong-khanh">Thiết kế Boots đậm chất Thu Đông của Vascara có mặt trên sàn runway của NTK Võ Công Khanh</a></p>
                                <img src="./img/att14.jpg" alt="">
                                <div class="content">
                                    Trong buổi trình diễn ra mắt BST Red Holiday của NTK
                                    Võ Công Khanh tại chương trình Vietnam International
                                    Fashion Festival 2021(VIFF), Combat Boots của Vascara
                                    có mặt ấn tượng.
