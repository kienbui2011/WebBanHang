                    ...
                    <nav id="primary-menu" class="main-navigation primary-navigation">
                        <ul id="menu-keva" class="nav-menu click-icon">
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-11953">
                                <a href="cartegory.html">CỬA HÀNG</a>
                            </li>
                ...
                <div class="header-center-items header-items  has-logo">
                    <div class="header-department ">
                        <span class="department-icon">
                            <span class="razzi-svg-icon ">
                                <svg aria-hidden="true" role="img" focusable="false" width="29" height="" viewBox="0 0 24 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="department-content">
                            <nav id="department-menu" class="department-menu main-navigation"></nav>
                        </div>
                    </div>
                    <!-- .header-department -->
                ...
                <div class="cartegory-right">
                    ...
                    <div class="cartegory-right-content ">
                        ...
                        <div class="cartegory-right-content-item row">
                            ...
                            $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 4 LIMIT 4";
                        ...
                        <div class="cartegory-right-content-item row">
                            ...
                            // Thực hiện truy vấn SQL
                            $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 4 LIMIT 4 OFFSET 3";
                        ...
                        <div class="cartegory-right-content-item row">
                            ...
                            // Thực hiện truy vấn SQL
                            $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 4 LIMIT 5 OFFSET 7"; // Retrieve 5 products starting from the 8th product (offset of 7)
                        ...
                        <div class="cartegory-right-content-item row">
                            ...
                            // Thực hiện truy vấn SQL
                            $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 4 LIMIT 5 OFFSET 11"; // Retrieve 5 products starting from the 12th product (offset of 11)
