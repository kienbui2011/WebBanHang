 ...
 -->
                ...
                <div class="cartegory-right-content ">
                    ...
                    <div class="cartegory-right-content-item row">
                        ...
                        $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 7 LIMIT 4";
                    ...
                    <div class="cartegory-right-content-item row">
                        ...
                        // Thực hiện truy vấn SQL
                        $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 7 LIMIT 4 OFFSET 4";
                    ...
                    <div class="cartegory-right-content-item row">
                        ...
                        // Thực hiện truy vấn SQL
                        $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 7 LIMIT 4 OFFSET 8"; // Retrieve 5 products starting from the 8th product (offset of 7)
                    ...
                    <div class="cartegory-right-content-item row">
                        ...
                        // Thực hiện truy vấn SQL
                        $sql = "SELECT * FROM `tbl_product` WHERE `brand_id` = 7 LIMIT 4 OFFSET 12"; // Retrieve 5 products starting from the 12th product (offset of 11)
            ...
            <div class="cartegory-right-content row ">
                ...
                <div class="cartegory-right-content-item">
                    ...
                    <div class="cartegory-right-bottom-items">
                        ...
                        $sql = "SELECT COUNT(*) as totalProducts FROM `tbl_product` WHERE `brand_id` = 7";
                        $result = mysqli_query($con, $sql);
