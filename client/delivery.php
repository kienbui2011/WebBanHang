    ...
    <header id="site-header" class="site-header  site-header__border">
                ...
                <div class="header-center-items header-items  has-menu has-logo">
                    <nav id="primary-menu" class="main-navigation primary-navigation">
                        <ul id="menu-keva" class="nav-menu click-icon">
                            <li
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-1685 current_page_item menu-item-11951 active">
                        ...
                        <a class="account-icon" href="Login.html" data-toggle="modal" data-target="account-modal">
                            <span class="razzi-svg-icon ">
                                <svg aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg"
                                    width="29" height="29" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                <div class="header-center-items header-items  has-logo">
                    <div class="header-department ">
                        <span class="department-icon">
                            <span class="razzi-svg-icon">
                                <svg id="show-menu-button" aria-hidden="true" role="img" focusable="false" width="29"
                                    height="" viewBox="0 0 24 18" fill="currentColor"
                        ...
                        <form method="get" class="form-search" action="#">
                            <div class="search-fields">
                                <input type="text" name="s" class="search-field" value=""
                                    placeholder="Điền tên hoặc mã sản phẩm" autocomplete="off">
                    ...
                    <div class="local">
                        <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 24 24" fill="none">
                            <path
                                d="M12.0001 21.6C12.0001 21.6 19.5131 14.9218 19.5131 9.91307C19.5131 5.76373 16.1494 2.40002 12.0001 2.40002C7.85076 2.40002 4.48706 5.76373 4.48706 9.91307C4.48706 14.9218 12.0001 21.6 12.0001 21.6Z"
                                stroke="black" stroke-width="1.8" />
                            <path
                                d="M14.4004 9.60018C14.4004 10.9257 13.3259 12.0002 12.0004 12.0002C10.6749 12.0002 9.60041 10.9257 9.60041 9.60018C9.60041 8.27469 10.6749 7.20018 12.0004 7.20018C13.3259 7.20018 14.4004 8.27469 14.4004 9.60018Z"
        ...
        <div class="header-mobile  header-contents logo-default hidden-md hidden-lg">
            <div class="mobile-menu">
                <a href="#" class="mobile-menu-toggle hamburger-menu" data-toggle="modal"
                    data-target="mobile-menu-modal">
                    <span class="razzi-svg-icon ">
                        <svg aria-hidden="true" role="img" focusable="false" width="24" height="18" viewBox="0 0 24 18"
            ...
            <div class="mobile-header-icons">
                ...
                <div class="header-cart">
                    <a href="" data-toggle="modal" data-target="cart-modal">
                        <span class="razzi-svg-icon icon-cart">
                            <svg aria-hidden="true" role="img" focusable="false" width="24" height="24"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M21.9353 20.0337L20.7493 8.51772C20.7003 8.0402 20.2981 7.67725 19.8181 7.67725H4.21338C3.73464 7.67725 3.33264 8.03898 3.28239 8.51523L2.06458 20.0368C1.96408 21.0424 2.29928 22.0529 2.98399 22.8097C3.66874 23.566 4.63999 24.0001 5.64897 24.0001H18.3827C19.387 24.0001 20.3492 23.5747 21.0214 22.8322C21.7031 22.081 22.0361 21.0623 21.9353 20.0337ZM19.6348 21.5748C19.3115 21.9312 18.8668 22.1275 18.3827 22.1275H5.6493C5.16836 22.1275 4.70303 21.9181 4.37252 21.553C4.042 21.1878 3.88005 20.7031 3.92749 20.2284L5.056 9.55014H18.9732L20.0724 20.2216C20.1223 20.7281 19.9666 21.2087 19.6348 21.5748Z"
                                    fill="currentColor"></path>
        ...
        <div class="delivery-top">
            ...
            <div class="delivery-top-delivery">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="35" viewBox="0 0 40 35" fill="none">
                    <rect width="40" height="35" fill="white" />
                    <path
                        d="M6.87433 13.3041H33.1244M12.1244 20.6085H16.4994M9.50002 6H30.4995C32.4326 6 33.9996 7.86727 33.9996 10.1724L34 25.8278C34 28.133 32.433 30 30.5 30L9.50035 29.9997C7.56741 29.9997 6.00042 28.131 6.00038 25.8259L6 10.174C5.99994 7.8688 7.56697 6 9.50002 6Z"
                        stroke="black" stroke-opacity="0.11" stroke-width="2.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </div>
        </div>
                ...
                <div class="footer-extra__inner">
                    ...
                    <nav class="menu-footer-extra-container">
                        ...
                        <ul id="footer-menu" class="footer-menu nav-menu menu">
                            <li id="menu-item-7396"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7396">
                        ...
                        <ul id="socials-menu" class="menu">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5790">
                                <a href="https://twitter.com/">
                                    <span class="razzi-svg-icon ">
                                        <svg aria-hidden="true" role="img" focusable="false" viewBox="0 0 24 24"
