        ...
        <div class="delivery-content row">
            <div class="delivery-content-left">
                ...
                <form action="delivery_class.php" method="POST">
                    ...
                    <label for="add_ress">Địa chỉ:</label>
                    <input type="text" name="add_ress" required><br>
                    <label for="note">Lưu ý cho Shop:</label>
            ...
            <div class="delivery-content-left">
                ...
                <form action="" method="POST">
                    ...
                    <div class="delivery-content-button">
                        ...
                        <input type="submit" value="Tiếp tục đến phương thức thanh toán" href="">
