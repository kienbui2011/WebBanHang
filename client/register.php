...
<body>
    ...
    <header id="site-header" class="site-header  site-header__border">
        ...
        <div class="header-mobile  header-contents logo-default hidden-md hidden-lg">
            ...
            <div class="mobile-header-icons">
                ...
                <div class="header-account">
                    <a class="account-icon" href="#index.php/my-account/" data-toggle="modal" data-target="account-modal">
                        <span class="razzi-svg-icon ">
                            <svg aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                <circle cx="12" cy="7" r="4"></circle>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($email) || empty($password) || empty($password_confirm) || empty($phone)) {
            ...
            $checkEmailQuery = "SELECT * FROM tbl_client_account WHERE email = '$email'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                if (mysqli_query($con, $insertQuery)) {
                    ...
                    $registrationFailure = true;
                    $errorMessage = "Lỗi: " . mysqli_error($con);
                }
            }
        }
        mysqli_close($con);
            ...
            <div class="login">
                ...
                <form method="POST">
                    ...
                    <p class="box-login">
                        ...
                        <input type="text" name="client_name" required placeholder="Full Name *" style="width: 100%;"><br><br>
                    </p>
                    <p class="box-login">
                    ...
                    <p class="box-login">
                        ...
                        <input type="password" name="pass_word_confirm" required placeholder="Confirm Password *" style="width: 100%;"><br><br>
                    </p>
                    <?php
                    if ($registrationFailure) {
                        echo "<h5 style='color: red; font-weight: bold; margin-top: -10px;'>$errorMessage</h5>";
                    }
                    if ($registrationSuccess) {
                        echo "<h5 style='color: green; font-weight: bold; margin-top: -10px;'>Đăng ký thành công!</h5>";
                    }
                    ?>
