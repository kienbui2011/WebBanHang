...
class product
{
    ...
    //                 OR cartegory_name LIKE '%" . $keyword . "%' 
    ...
    public function update_product($product_id , $product_price, $product_price_new, $quantity, $product_desc, $product_details, $product_img, $product_img_desc1, $product_img_desc2, $product_img_desc3)
    {
        $product_name = $_POST['product_name'];
        $cartegory_id = $_POST['cartegory_id'];
        $brand_id = $_POST['brand_id'];
        ...
        // Process file uploads and update the database fields
        foreach ($file_upload_fields as $field) {
            if (isset($_FILES[$field]) && $_FILES[$field]['error'] === UPLOAD_ERR_OK) {
                $file_name = $_FILES[$field]['name'];
                $file_tmp = $_FILES[$field]['tmp_name'];
        ...
        $query = "UPDATE tbl_product SET 
            ...
            product_img_desc1 = '$product_img_desc1',
            product_img_desc2 = '$product_img_desc2',
            product_img_desc3 = '$product_img_desc3'
