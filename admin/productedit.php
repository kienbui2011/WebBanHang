...
<div class="admin-content-right">
    <div class="admin-content-right-product_add">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <textarea required name="product_desc" id="editor1" cols="30" rows="5" placeholder="Giới thiệu sản phẩm"></textarea>
            <label>Chi tiết sản phẩm</label>
            <textarea required name="product_details" id="editor2" cols="30" rows="5" placeholder="Chi tiết sản phẩm"></textarea>
